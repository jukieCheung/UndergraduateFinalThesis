...
checkpoint = torch.load('/home/jukie/Project/logs/resnet18_random0/best_cls.pth')
...
utils.plot_confusion_matrix(true_v,pred_v,classes = target_class)
...
y_true_argmax = np.argmax(true_v,axis=1)
y_pred = np.array(pred_v)
    #y_pred_argmax = np.argmax(y_pred,axis=1)
cm = confusion_matrix(y_true_argmax, y_pred)
#cm = confusion_matrix(true_v, pred_v)
f1_macro = f1_score(y_true_argmax, y_pred, average='macro')
